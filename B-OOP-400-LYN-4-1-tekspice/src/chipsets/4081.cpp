...
void _4081_::simulate(std::size_t tick)
{
    Table table;
    Vectors vectors;
    std::string pin;
...
nts::Tristate _4081_::compute(std::size_t pin)
{
    return (nts::TRUE);
}

void _4081_::setLink(std::size_t pin, nts::IComponent &other, std::size_t other_pin)
{
    return;
}

void _4081_::dump() const
{
    return;
}